...
var Spell = /** @class */ (function () {
    ...
    Spell.readAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dir, output, index, file_list, promise_list, _i, file_list_1, file_raw, file, _a, promise_list_1, spell_promise, spell, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        for (_i = 0, file_list_1 = file_list; _i < file_list_1.length; _i++) {
                        ...
                        _a = 0, promise_list_1 = promise_list;
                        _d.label = 3;
                    case 3:
                        if (!(_a < promise_list_1.length)) return [3 /*break*/, 7];
                        spell_promise = promise_list_1[_a];
                        _c = (_b = JSON).parse;
                        return [4 /*yield*/, spell_promise];
                    case 4: return [4 /*yield*/, (_d.sent()).text()];
                    case 5:
                        spell = _c.apply(_b, [_d.sent()]);
